...
export default function ShowcaseCimento() {
  return (
    <div className="section-showcase not-slide-drag show" data-category="5" type="all_products" order="quantity_sold">
      {"\n "}
      <div className="container">
        ...
        <div className="list-product flex f-wrap swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
          {"\n "}
          <div className="list-product__items swiper-wrapper" id="swiper-wrapper-c270dc42ad2c363f" aria-live="off">
            {"\n \n "}
            <div className="item swiper-slide swiper-slide-active" role="group" aria-label="1 / 4" ref={rawStyle("width:320px")}>
              {"\n \n \n \n"}
              <div className="product upon_request has-fast-shopping" id="product-1726670685" product-ref="27447">
                {"\n \n "}
                <div className="image">
                  {"\n \n "}
                ...
                <div className="buy-whatsapp buy-whatsapp--list-product">
                  {"\n "}
                  <a href={"https://api.whatsapp.com/send?phone=5511933777529&text=Ol%C3%83%C2%A1,%20gostei%20deste%20produto:%20Nome:%20Cimento%20Exato%20CP%20IV%2050KG%20-%20Cau%C3%83%C2%AA%20|%20Ref:%2027447"} target="_blank">
                    {"\n "}
            ...
            <div className="item swiper-slide swiper-slide-next" role="group" aria-label="2 / 4" ref={rawStyle("width:320px")}>
              {"\n \n \n \n"}
              <div className="product upon_request has-fast-shopping" id="product-1640657925" product-ref="13998">
                {"\n \n "}
                <div className="image">
                  {"\n \n "}
                ...
                <div className="buy-whatsapp buy-whatsapp--list-product">
                  {"\n "}
                  <a href={"https://api.whatsapp.com/send?phone=5511933777529&text=Ol%C3%83%C2%A1,%20gostei%20deste%20produto:%20Nome:%20Cimento%20Estrutura%2040KG%20CP-V%20-%20Cau%C3%83%C2%AA%20|%20Ref:%2013998"} target="_blank">
                    {"\n "}
                    <i className="icon icon-whatsapp v-align-middle" />
                    {"\n Comprar pelo Whats\n "}
                  </a>
            ...
            <div className="item swiper-slide" role="group" aria-label="3 / 4" ref={rawStyle("width:320px")}>
              {"\n \n \n \n"}
              <div className="product upon_request has-fast-shopping" id="product-595912856" product-ref="10009">
                {"\n \n "}
                <div className="image">
                  {"\n \n "}
                ...
                <div className="buy-whatsapp buy-whatsapp--list-product">
                  {"\n "}
                  <a href={"https://api.whatsapp.com/send?phone=5511933777529&text=Ol%C3%83%C2%A1,%20gostei%20deste%20produto:%20Nome:%20Cimento%20Todas%20As%20Obras%2050KG%20CPII%20-%20Votoran%20|%20Ref:%2010009"} target="_blank">
                    {"\n "}
                    <i className="icon icon-whatsapp v-align-middle" />
                    {"\n Comprar pelo Whats\n "}
                  </a>
            ...
            <div className="item swiper-slide" role="group" aria-label="4 / 4" ref={rawStyle("width:320px")}>
              {"\n \n \n \n"}
              <div className="product upon_request has-fast-shopping" id="product-2002283887" product-ref="22114">
                {"\n \n "}
                <div className="image">
                  {"\n \n "}
                ...
                <div className="buy-whatsapp buy-whatsapp--list-product">
                  {"\n "}
                  <a href={"https://api.whatsapp.com/send?phone=5511933777529&text=Ol%C3%83%C2%A1,%20gostei%20deste%20produto:%20Nome:%20Cimento%20Uso%20Geral%2050%20Kg%20CPII%20-%20Cau%C3%83%C2%AA%20|%20Ref:%2022114"} target="_blank">
                    {"\n "}
                    <i className="icon icon-whatsapp v-align-middle" />
                    {"\n Comprar pelo Whats\n "}
                  </a>
          ...
          {"\n \n "}
          <div className="prev swiper-button-disabled sf-hidden" tabIndex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-c270dc42ad2c363f" aria-disabled="true">
            {"\n \n "}
          </div>
          {"\n "}
          <div className="next swiper-button-disabled sf-hidden" tabIndex="-1" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-c270dc42ad2c363f" aria-disabled="true">
            {"\n \n "}
          </div>
          {" \n "}
