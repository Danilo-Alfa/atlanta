        ...
        <nav className="nav">
          ...
          <div className="container">
            ...
            <ul className="list flex justify-between">
              ...
              {"\n \n "}
              <li className="first-level sub">
                {"\n \n "}
                <a href="https://www.atlantanet.com.br/materiais-de-construcao" title="Material de Construção" className="not-clickable">
                  {"\n "}
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Material de Construção" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-17)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                {"\n \n "}
                <ul className="sub-list second-level products-show" ref={rawStyle("left:0px;max-height:8845px")}>
                  {"\n \n "}
                  <ul className="categories-children">
                    {"\n \n \n "}
                    <li className="sub">
                      {"\n \n "}
                      <a href="https://www.atlantanet.com.br/cimento" title="Cimento">
                  ...
                  <div className="category-product">
                    {"\n \n \n "}
                    <div className="list-product flex f-wrap">
                      {"\n "}
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-fast-shopping" id="product-983362490" product-ref="30137">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/material-de-construcao/cimento-csn-cp3-32rs-50-kg-csn" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-3a2f50f59724.svg" alt="Cimento CPIII 32RS 50KG - CSN" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-33)!important;background-size:contain!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/material-de-construcao/cimento-csn-cp3-32rs-50-kg-csn">
                            {"\n "}
              ...
              <li className="first-level sub">
                ...
                <a href="https://www.atlantanet.com.br/tintas-eacessorios" title="Tintas e Acessórios" className="not-clickable">
                  ...
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Tintas e Acessórios" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-18)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                <ul className="sub-list second-level products-show" ref={rawStyle("left:0px;max-height:8845px")}>
                  ...
                  <div className="category-product">
                    ...
                    <div className="list-product flex f-wrap">
                      ...
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-fast-shopping" id="product-501470567" product-ref="31457">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/tintas-e-acessorios/tinta-ferromadeira/tinta-ultra-resistente-brilhante-az-mar-3-6l-coral" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-4aa507c3f123.webp" alt="Tinta Ultra Resistente Brilhante Azul Mar 3,6L - Coral" data-ll-status="loaded" />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                            <div className="product-tags tags-custom sf-hidden" data-tags-count="0">
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/tintas-e-acessorios/tinta-ferromadeira/tinta-ultra-resistente-brilhante-az-mar-3-6l-coral">
                            {"\n "}
                            <div className="wrapper-product-name">
                              {"\n "}
                              <div className="product-name">
                                {"\n Tinta Ultra Resistente Brilhante Azul Mar 3,6L - Coral\n "}
                              </div>
                              {"\n "}
                            </div>
                            {"\n "}
              ...
              <li className="first-level sub">
                ...
                <a href="https://www.atlantanet.com.br/impermeabilizante" title="Impermeabilizante" className="not-clickable">
                  ...
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Impermeabilizante" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-19)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                {"\n \n "}
                <ul className="sub-list second-level products-show" ref={rawStyle("left:-30.2188px;max-height:8845px")}>
                  {"\n \n "}
                  <ul className="categories-children">
                    {"\n \n \n "}
                    <li>
                  ...
                  <div className="category-product">
                    ...
                    <div className="list-product flex f-wrap">
                      ...
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-fast-shopping" id="product-86139175" product-ref="13798">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/impermeabilizante/neutrol-base-agua-18l-vedacit" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-e86dc8bbb474.webp" alt="Neutrol Base Água 18L Vedacit" data-ll-status="loaded" />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                            <div className="product-tags tags-custom sf-hidden" data-tags-count="0">
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/impermeabilizante/neutrol-base-agua-18l-vedacit">
                            {"\n "}
                            <div className="wrapper-product-name">
                              {"\n "}
                              <div className="product-name">
                                {"\n Neutrol Base Água 18L Vedacit\n "}
                              </div>
                              {"\n "}
                            </div>
                            {"\n "}
              ...
              <li className="first-level sub">
                ...
                <a href="https://www.atlantanet.com.br/madeiras" title="Madeiras" className="not-clickable">
                  ...
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Madeiras" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-20)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                {"\n \n "}
                <ul className="sub-list second-level products-show" ref={rawStyle("left:-199.516px;max-height:8845px")}>
                  {"\n \n "}
                  <ul className="categories-children">
                    {"\n \n \n "}
                    <li>
                  ...
                  <div className="category-product">
                    ...
                    <div className="list-product flex f-wrap">
                      ...
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-fast-shopping" id="product-270537561" product-ref="26492">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/madeiras/pontalete/pontalete-bruto-sereuc-e-3-00ml" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-42a1aebb9006.webp" alt="Pontalete Bruto Ser/Euc  E  3.00ML" data-ll-status="loaded" />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                            <div className="product-tags tags-custom sf-hidden" data-tags-count="0">
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/madeiras/pontalete/pontalete-bruto-sereuc-e-3-00ml">
                            {"\n "}
                            <div className="wrapper-product-name">
                              {"\n "}
                              <div className="product-name">
                                {"\n Pontalete Bruto Ser/Euc E 3.00ML\n "}
                              </div>
                              {"\n "}
                            </div>
                            {"\n "}
              ...
              <li className="first-level sub">
                ...
                <a href="https://www.atlantanet.com.br/telha" title="Telha" className="not-clickable">
                  ...
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Telha" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-21)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                {"\n \n "}
                <ul className="sub-list second-level products-show" ref={rawStyle("left:-299.719px;max-height:8845px")}>
                  {"\n \n "}
                  <ul className="categories-children">
                    {"\n \n \n "}
                    <li>
                  ...
                  <div className="category-product">
                    ...
                    <div className="list-product flex f-wrap">
                      ...
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-secondary-image has-fast-shopping" id="product-356719557" product-ref="23113">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/telha/telhas/telha-ondulada-2-13x1-10-6mm-brasilit" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-474648c35ca8.webp" alt="Telha Ondulada 2.13X1.10 6MM - Brasilit" data-ll-status="loaded" />
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-5361042f0011.webp" alt="Telha Ondulada 2.13X1.10 6MM - Brasilit" data-ll-status="loaded" />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                            <div className="product-tags tags-custom sf-hidden" data-tags-count="0">
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/telha/telhas/telha-ondulada-2-13x1-10-6mm-brasilit">
                            {"\n "}
                            <div className="wrapper-product-name">
                              {"\n "}
                              <div className="product-name">
                                {"\n Telha Ondulada 2.13X1.10 6MM - Brasilit\n "}
                              </div>
                              {"\n "}
                            </div>
                            {"\n "}
              ...
              <li className="first-level sub">
                ...
                <a href="https://www.atlantanet.com.br/ferramentas" title="Ferramentas" className="not-clickable">
                  ...
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Ferramentas" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-22)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                {"\n \n "}
                <ul className="sub-list second-level products-show" ref={rawStyle("left:-372.531px;max-height:8845px")}>
                  {"\n \n "}
                  <ul className="categories-children">
                    {"\n \n \n "}
                    <li className="sub">
                  ...
                  <div className="category-product">
                    ...
                    <div className="list-product flex f-wrap">
                      ...
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-fast-shopping" id="product-831860950" product-ref="34090">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/ferramentas/ferramentas-manuais/desempenadeira/desempenadeira-aco-lisa-12x24cm-tramontina" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-d7140eedea61.webp" alt="Desempenadeira Aço Lisa 12X24cm Tramontina" data-ll-status="loaded" />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                            <div className="product-tags tags-custom sf-hidden" data-tags-count="0">
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/ferramentas/ferramentas-manuais/desempenadeira/desempenadeira-aco-lisa-12x24cm-tramontina">
                            {"\n "}
                            <div className="wrapper-product-name">
                              {"\n "}
                              <div className="product-name">
                                {"\n Desempenadeira Aço Lisa 12X24cm Tramontina\n "}
                              </div>
                              {"\n "}
                            </div>
                            {"\n "}
              ...
              <li className="first-level sub">
                ...
                <a href="https://www.atlantanet.com.br/hidraulica" title="Hidráulica" className="not-clickable">
                  ...
                  <div className="category-image">
                    {"\n "}
                    <img className="lazyload loaded" alt="Hidráulica" src="/assets/img-6e4e47f90b1c.svg" data-ll-status="loaded" ref={rawStyle("background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-23)!important;background-size:100% 100%!important;background-origin:content-box!important;background-repeat:no-repeat!important")} />
                    {" \n "}
                  </div>
                  {"\n "}
                  <div className="name">
                ...
                {"\n \n "}
                <ul className="sub-list second-level products-show" ref={rawStyle("left:-498.719px;max-height:8845px")}>
                  {"\n \n "}
                  <ul className="categories-children">
                    {"\n \n \n "}
                    <li>
                  ...
                  <div className="category-product">
                    ...
                    <div className="list-product flex f-wrap">
                      ...
                      <div className="list-product__items">
                        {"\n \n \n \n"}
                        <div className="product upon_request has-fast-shopping" id="product-614447820" product-ref="13436">
                          {"\n \n "}
                          <div className="image">
                            {"\n \n "}
                            <a href="https://www.atlantanet.com.br/hidraulica/tubos-e-conexoes/curva-45-pvc-soldavel-40mm-marrom-tigre" className="space-image">
                              {"\n "}
                              <img loading="lazy" className="lazyload loaded" src="/assets/img-191501660b56.webp" alt="Curva 45° PVC Soldável 40mm Marrom Tigre" data-ll-status="loaded" />
                              {"\n \n "}
                            </a>
                            {"\n \n \n \n \n \n "}
                            <div className="product-tags tags-custom sf-hidden" data-tags-count="0">
                          ...
                          {"\n "}
                          <a className="product-info" href="https://www.atlantanet.com.br/hidraulica/tubos-e-conexoes/curva-45-pvc-soldavel-40mm-marrom-tigre">
                            {"\n "}
                            <div className="wrapper-product-name">
                              {"\n "}
                              <div className="product-name">
                                {"\n Curva 45° PVC Soldável 40mm Marrom Tigre\n "}
                              </div>
                              {"\n "}
                            </div>
                            {"\n "}
